...
| 32   | `ridingFinishAndEnd.spec.ts`'s completion-detection test: diagnosed, corrected (test-only) | Diagnosed and corrected 12 September 2026        | [`current-status.md#item-32`](docs/project/current-status.md#item-32) |
