...
| 109  | Prevent the Planning waypoint marker and placement control from colliding                     | Pending — selected next                          | [`backlog.md#item-109`](docs/project/backlog.md#item-109)             |
| 110  | North-pointing orientation indicator on the north-up control                                  | Pending                                          | [`backlog.md#item-110`](docs/project/backlog.md#item-110)             |
