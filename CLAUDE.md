...
Stable item numbers never change regardless of which file an item's text lives in. Item 92 is currently selected as the next implementation item.
...
| 92   | Storage-health quota/estimate signal                                                          | Pending — selected next item                     | [`backlog.md#item-92`](docs/project/backlog.md#item-92)               |
