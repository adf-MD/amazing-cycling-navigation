...
| 107  | Investigate navigation recovery around overlapping route geometry after suspension            | Pending investigation — selected next            | [`backlog.md#item-107`](docs/project/backlog.md#item-107)             |
| 108  | Relocate active-riding map-imagery status and compact the climb cue                           | Pending                                          | [`backlog.md#item-108`](docs/project/backlog.md#item-108)             |
| 109  | Prevent the Planning waypoint marker and placement control from colliding                     | Pending                                          | [`backlog.md#item-109`](docs/project/backlog.md#item-109)             |
