...
Stable item numbers never change regardless of which file an item's text lives in. Item 77 is the next selected item. Item 78 follows it in order as a subsequent approved slice.
...
| 77   | Climb-only colouring and legend for the pre-ride full profile                                 | Next — selected implementation slice             | [`backlog.md#item-77`](docs/project/backlog.md#item-77)               |
...
Items 6–10, 13–15, 17–27, 29–31, 33–42, 44–58, 62–65 and 67–76 are completed (`— done`) and live in [`docs/project/history/`](docs/project/history/README.md). Item 43 is a follow-up acceptance checklist and lives in [`docs/project/current-status.md`](docs/project/current-status.md).
