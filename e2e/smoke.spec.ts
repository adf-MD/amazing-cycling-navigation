...
test.describe("Riding mode map", () => {
  ...
  // see planning.spec.ts, which needs the same workaround. Scoped to
  // this describe block only: the sibling "app shell" test above never
  // constructs a map and stays hermetic without it.
