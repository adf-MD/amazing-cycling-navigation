...
## Item 117 — Show the active session's route name instead of its internal identifier

_Category: Rider-facing presentation_

117. **Show the active session's route name instead of its internal identifier**
